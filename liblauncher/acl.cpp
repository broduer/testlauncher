...
extern "C" JNIEXPORT void JNICALL Java_net_openrune_launcher_Launcher_setFileACL(JNIEnv *env, jclass clazz, jstring folderJs, jobjectArray sidsJa) {
...
extern "C" JNIEXPORT jstring JNICALL Java_net_openrune_launcher_Launcher_getUserSID(JNIEnv *env, jclass clazz) {
    HANDLE hToken;
