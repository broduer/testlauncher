...
extern "C" JNIEXPORT jboolean JNICALL Java_net_openrune_launcher_Launcher_isProcessElevated(JNIEnv *env, jclass clazz, jlong pid) {
...
extern "C" JNIEXPORT jlong JNICALL Java_net_openrune_launcher_Launcher_runas(JNIEnv *env, jclass clazz, jstring pathObj, jstring argsObj) {
