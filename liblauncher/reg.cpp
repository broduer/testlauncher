...
extern "C" JNIEXPORT jstring JNICALL Java_net_openrune_launcher_Launcher_regQueryString(JNIEnv *env, jclass clazz, jstring lpSubKeyJs, jstring lpValueJs) {
...
extern "C" JNIEXPORT jboolean JNICALL Java_net_openrune_launcher_Launcher_regDeleteValue(JNIEnv *env, jclass clazz, jstring keyObj, jstring subKeyObj,
                                                                                         jstring valueObj) {
